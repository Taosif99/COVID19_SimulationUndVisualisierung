...
public class PlayTooltipManager : MonoBehaviour
{
    private static PlayTooltipManager instance;
    [SerializeField] private RectTransform canvasRectTransform;
    [SerializeField] private PlayTooltip playButton;
    ...
    private void Awake()
    {
        ...
        SetText(playButton.TooltipText);
    }
