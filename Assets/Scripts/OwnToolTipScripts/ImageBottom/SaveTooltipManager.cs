...
public class SaveTooltipManager : MonoBehaviour
{
    private static SaveTooltipManager instance;
    [SerializeField] private RectTransform canvasRectTransform;
    [SerializeField] private SaveTooltip saveButton;
    ...
    private void Awake()
    {
        ...
        SetText(saveButton.TooltipText);
    }
