...
public class NumberofPeopleTooltipManager : MonoBehaviour
{
    private static NumberofPeopleTooltipManager instance;
    [SerializeField] private RectTransform canvasRectTransform;
    [SerializeField] private NumberOfPeopleTooltip numberOfPeopleTooltipInputField;
    ...
    private void Awake()
    {
        ...
        SetText(numberOfPeopleTooltipInputField.TooltipText);
    }
