...
public class GraphTooltipManager : MonoBehaviour
{
    private static GraphTooltipManager instance;
    [SerializeField] private RectTransform canvasRectTransform;
    [SerializeField] private GraphTooltip graphButton;
    ...
    private void Awake()
    {
        ...
        SetText(graphButton.TooltipText);
    }
