...
public class SimpleTooltip1 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private void Awake()
    {
        ...
        tooltipController = FindObjectOfType<Tooltip>();
    ...
    public static Tooltip AddTooltipPrefabToScene()
    {
        return Instantiate(Resources.Load<GameObject>("SimpleTooltip1")).GetComponentInChildren<Tooltip>();
    }
    ...
    public void ShowTooltip()
    {
        ...
        tooltipController.SetCustomStyledText(infoLeft, simpleTooltipStyle, Tooltip.TextAlign.Left);
        tooltipController.SetCustomStyledText(infoRight, simpleTooltipStyle, Tooltip.TextAlign.Right);
